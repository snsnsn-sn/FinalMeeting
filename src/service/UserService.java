...
public class UserService {
     ...
     * @return 布尔值 是否插入成功
     */
    public boolean insert(String userId,String password,String phone,String part) { return userImpl.insert(userId,password,phone,part);}

    public boolean insert(String userId,String name,String password,String phone,String part) { return userImpl.insert(userId,name,password,phone,part);}
     ...
     * @return 布尔值 是否删除成功
     */
    public boolean delete(String userId) {return userImpl.deleteByUserId(userId);}
