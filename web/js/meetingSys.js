...
function check_login(uid, name) {
    if (uid != 'null') {
        $("#nav_bar").html(
            ...
            '                            <li><a href="/ms/userPage/userCenter.jsp">个人中心</a></li>\n' +
...
function getLeft(panelID, pageID) {
    ...
    $("#left_menu").html(
        ...
        '                        <!--嵌套列表组-->\n' +
        '                        <ul class="list-group">\n' +
        '                            <li class="list-group-item"><a href="/ms/userPage/index.jsp"' + b[0] + '>会议一览</a>\n' +
        '                            </li>\n' +
        '                            <li class="list-group-item"><a href="/ms/userPage/MeetingHall/meetingQuery.jsp" ' + b[1] + '>会议查询</a>\n' +
        '                            </li>\n' +
        '                        </ul>\n' +
        '                    </div>\n' +
        '                </div>\n' +
        ...
        '                        <!--嵌套列表组-->\n' +
        '                        <ul class="list-group">\n' +
        '                            <li class="list-group-item"><a href="/ms/userPage/MyMeeting/created.jsp" ' + b[2] + '>我发起的会议</a></li>\n' +
        '                            <li class="list-group-item"><a href="/ms/userPage/MyMeeting/joined.jsp" ' + b[3] + '>我加入的会议</a></li>\n' +
        '                        </ul>\n' +
        '                    </div>\n' +
        '                </div>\n' +
        '            </div>\n' +
        ...
        '                        <!--嵌套列表组-->\n' +
        '                        <ul class="list-group">\n' +
        '                            <li class="list-group-item"><a href="/ms/userPage/MyOrder/pickOrder.jsp" ' + b[4] + '>接驾订单</a></li>\n' +
        '                            <li class="list-group-item"><a href="/ms/userPage/MyOrder/hotelOrder.jsp" ' + b[5] + '>酒店订单</a></li>\n' +
        '                        </ul>\n' +
        '                    </div>\n' +
        '                </div>\n' +
        '            </div>\n' +
                ...
                $.get(
                    ...
                    function (response) {
                        ...
                        code = '<div class="row" style="margin: 20px 0px">\n' +
                            ...
                            '        <img style="height: 183px;width:345px" src="https://www.canevent.com/index3.0/images/36-img.jpg"\n' +
                            '             alt="会议图片">\n' +
                            '    </div>\n' +
                            ...
                            '        <p>#' + part + '#\n' +
                            '        <p>' + brief + '</p>\n' +
                            '        <a style="margin-top: 10px" class="btn btn-default" href="/ms/userPage/MeetingHall/meetingInfo.jsp?mid=' + mid + '">了解更多</a>\n' +
                            '    </div>\n' +
                            '</div>';
...
function getMeeting() {
    if (requestId == 'null') {
        ...
        window.location.href = '/ms/userPage/MyMeeting/created.jsp';
    }
    $.get(
        '/ms/meeting',
        ...
        function (response) {
            ...
            for (var i in o) {
                ...
                code += '<tr>' +
                    ...
                    '<td>' + o[i].place + '</td>' +
                    '<td>' + meetingState + '</td>' +
                    '<td><a class="btn text-info text- btn-sm" href="/ms/userPage/MeetingHall/meetingInfo.jsp?mid=' + o[i].meetingId + '">详情</a></td>' +
                    '</tr>';
                count += 1;
            }
            ...
            if (response == '请先登录')
                ...
                for (var i in o) {
                    ...
                    code += '<tr>' +
                        ...
                        '<td>' + o[i].place + '</td>' +
                        '<td>' + meetingState + '</td>' +
                        '<td><a class="btn text-info btn-sm" href="/ms/userPage/MeetingHall/meetingInfo.jsp?mid=' + o[i].meetingId + '">详情</a> </td>' +
                        '</tr>';
                    count += 1;
                }
                code += '</tbody></table>';
