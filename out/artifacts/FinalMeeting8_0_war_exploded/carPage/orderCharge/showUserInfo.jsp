...
<head>
    ...
    <script>
        function completeOrder(userId,driverId) {
            ...
            <div class="page-wrap">
                ...
                <section class="page-hd">
                    ...
                    <table class="table text-center">
                        <tr>
                            <td style="font-size: 15px;font-weight: bold">用户姓名</td>
                            <td style="font-size: 15px;font-weight: bold">用户电话</td>
                        </tr>

                        <tr>
                            <td style="font-size: 15px;font-weight: bold">${sessionScope.UserInfo.name}</td>
                            <td style="font-size: 15px;font-weight: bold">${sessionScope.UserInfo.phone}</td>
                        </tr>
                    </table>
                </section>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/Final/Info?method=driverChangeInfo" method="post">
                    ...
                    <div class="form-group">
                        <label>修改司机名</label>
                        <input type="text" class="form-control" name="alterName" id="alterName" placeholder="请输入车队名" required>
                    </div>
