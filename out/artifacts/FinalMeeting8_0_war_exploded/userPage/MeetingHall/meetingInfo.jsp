    ...
    <script>
        ...
        $(function () {
            ...
            $.get(
                ...
                function (response) {
                    $("#showMeetingImg").attr('src', response);
                }
            )
...
<div class="col-sm-9">
    ...
    <div class="page-header">
        <!--点这个按钮回到我创建的会议页面-->
        <button class="btn btn-sm" onclick="window.location.href='/Final/userPage/index.jsp'">
            ...
            <div class="pane panel-default">
                ...
                <div class="col-sm-5">
                    <div class="panel-body" style="margin: 20px 36px;height:200px">
                        <img style="width: 100%;height: 180px" id="showMeetingImg">
                    </div>
